...
public class StuckServlet extends HttpServlet {
    ...
    public void writeToFileFF(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            PrintWriter out = response.getWriter();
            response.setContentType("text/html");
            out.print("<h2>Out File: !" + request.getParameter("pathtofile") + "!</h2>");
            String pathtofile = request.getParameter("pathtofile");
            File fout = new File(pathtofile);
            FileOutputStream fos = new FileOutputStream(fout);

            System.out.println("Out File: " + pathtofile);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("writeToFile") != null) {
            ...
            writeToFileFF(request, response);
        }
